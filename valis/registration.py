...
class Slide(object):
    ...
    def __init__(self, src_f, image, val_obj, reader, name=None, anno_f=None):
        """
        Parameters
        ----------
        src_f : str
...
class Valis(object):
    ...
    def convert_imgs(self, series=None, reader_cls=None, shrink=False):
        ...
        for i, f in enumerate(tqdm.tqdm(self.original_img_list)):
            ...
            slide_obj = Slide(f, img, self, reader, name=slide_name, anno_f=slide_anno_f)
    ...
    def prep_images_for_large_non_rigid_registration(self, max_img_dim,
        ...
        for slide_obj in tqdm.tqdm(self.slide_dict.values()):
            ...
            if not use_tiler:
                ...
                if self.norm_method == "histo_match":
                    processed_img = preprocessing.match_histograms(processed_img, self.target_processing_stats)
                elif self.norm_method == "img_stats":
